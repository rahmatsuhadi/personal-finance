...
import { CategoryFormModal } from "@/components/molecules";
    ...
    <div className="flex flex-col h-full bg-brutal-bg">
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3 pb-24">
        {activeCategories.length === 0 ? (
          <EmptyState
            ...
            description="Tap ikon tambah di kanan atas untuk membuat kategori baru."
      ...
      {editingCategory && (
        <CategoryFormModal
          ...
          onSave={async (data: Omit<Category, "id" | "updatedAt">) => {
